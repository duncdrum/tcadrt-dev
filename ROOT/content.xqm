...
declare function content:home($list as element(span)?)
{
  ...
  <head>
   ...
   <link href="/static/css/tcadrt.css" rel="stylesheet"></link>
...
<body>
  ...
  <nav class="navbar navbar-default">
          <div class="container-fluid">
              ...
              <a href="/"><img src="/static/img/tcadrt-logo-vs.png" style="position: relative; left:-16; float:left; margin-left:0; margin-top: 0; margin-right:20px; margin-bottom:0px;" width="56px" height="50px"/></a>
                  ...
                  <a class="navbar-brand" href="/">Traditional Chinese Architecture Digital Research Tool</a>
              </div>
              <!-- Collect the nav links, forms, and other content for toggling -->
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
                      <li class="active"><a href="/">Home <span class="sr-only"
                              >(current)</span></a></li>
  ...
  <footer class="footer">
      <div class="container">
        ...
        <div class="sponsors">
        <a href="https://www.neh.gov/" class="logo" target="_blank"><img src="/static/img/neh-logo.png"/></a>
        <a href="http://www.library.vanderbilt.edu/" class="logo" target="_blank"><img src="/static/img/heard-library-logo.png"/></a>
        <a href="http://www.grahamfoundation.org/" class="logo" target="_blank"><img src="/static/img/gf-logo.png"/></a>
        <a href="https://as.vanderbilt.edu/" class="logo" target="_blank"><img src="/static/img/vanderbilt-cas-logo.png"/></a>
        <a href="https://mellon.org/" class="logo" target="_blank"><img src="/static/img/mellon-logo.png"/></a>
        <a href="https://as.vanderbilt.edu/historyart/" class="logo" target="_blank"><img src="/static/img/hart-logo.png"/></a>
        </div>
      </div>
    </footer>
</body>
...
<body>
  ...
  <nav class="navbar navbar-default">
          <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
                      <li ><a href="/">Home <span class="sr-only"
                              >(current)</span></a></li>
                      <li><a href="/features">Features</a></li>
                      <li><a href="/sites">Sites</a></li>
                      <li class="active"><a href="/tool">Tool</a></li>
...
-->
  ...
  <!--Here is where the info and images get inserted-->
    ...
    <footer class="footer">
      ...
      <script src="static/js/tang-song.js"></script>
...
declare function content:buildings-by-feature($feature as xs:string?) as element(span)
{
  ...
  let $site := fn:collection("site")
  return
  element span {
    element h1 {"Structural Elements"},
    let $records := $structural-elements/metadata/record
    for $record in $records
    let $pinyin-identifier := $record/skos_pref_label_pinyin/text()
    let $identifier := $record/identifier/text()
    where $feature = $pinyin-identifier or fn:empty($feature)
    order by $identifier
    return
     element p {
       element b {$pinyin-identifier},
       element ul {
        for $record in $buildings/metadata/record
        for $element in $record/child::element()
        where $element/fn:node-name() = $identifier and $element/text() castable as xs:integer and xs:integer($element/text()) ge 1
        let $site-name := $site/metadata/record[built_work_site_primary_key/text() = $record/built_work_site_foreign_key/text()]/site_name_pinyin/text()
        order by fn:lower-case($record/building_name_pinyin/text())
        return element li {
           element a {attribute href { "/work/" || $record/work_building_identifier/text() || ".ttl"}, $record/building_name_pinyin/text()},
           "&#32; ",
           element a {attribute href { "/work/" || $record/built_work_site_foreign_key/text() || ".ttl"}, "(" || $site-name || ")"}
         }
       }
     }
   }
...
declare function content:list-sites($feature as xs:string?) as element(span)
{
  element span {
     ...
     let $buildings := fn:collection("building")
     let $sites := fn:collection("site")/metadata/record
     for $site in $sites
     return
       element a {attribute href {"/work/" ||$site/built_work_site_primary_key/text()  || ".ttl"}, $site/site_name_pinyin/text(),
       element ul {
         let $buildings-on-site := $buildings/metadata/record[built_work_site_foreign_key = $site/built_work_site_primary_key]
         for $building in $buildings-on-site
         order by fn:lower-case($building)
         return element li {element a {attribute href { "/work/" || $building/work_building_identifier/text() || ".ttl"}, $building/building_name_pinyin/text()}}}}
}
};
